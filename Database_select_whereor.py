...
# where jenis = mamalia
kursor.execute("SELECT * FROM HEWAN WHERE asal = 'Sumatera'")
kursor.execute("SELECT * FROM HEWAN WHERE jml_sekarang >= '500'")
baris_tebel = kursor.fetchall()
#BUAT TABEL PEGAWAI
print("DATA HEWAN ASAL SUMATERA DAN LEBIH DARI 500")
print("="*80)
print('-'*80)
